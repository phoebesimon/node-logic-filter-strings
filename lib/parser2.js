...
//i.e. '(foo === "bar")'
exports.parenCondition = strings.lparen.then(exports.condition).skip(strings.rparen);

//i.e. '!(foo === "bar")'
exports.notCondition = seq(
  strings.not,
  exports.parenCondition
).map(function(r) {console.log('NOT CONDITION', r); return r; });

exports.anyCondition = alt(
  exports.condition,
  exports.parenCondition,
  exports.notCondition
).map(function(r) { console.log('ANY CONDITION', r); return r; });


exports.expression = lazy('an expression', function() {
  return alt(
    strings.lparen.then(exports.atom).skip(strings.rparen).map(function(r) { console.log('START ATOM', r); return r;}),
    exports.atom,
    exports.form
  ).map(function(result) {
...
exports.filter = {
  parse: function(string) {
    ...
    string = '(' + string + ')';
    console.log('PARSED', string, exports.expression.parse(string));
